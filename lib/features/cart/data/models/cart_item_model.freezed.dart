...
class _$CartItemModelImpl extends _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(cartItemId: $cartItemId, productId: $productId, productName: $productName, brand: $brand, imageUrl: $imageUrl, size: $size, color: $color, colorHex: $colorHex, quantity: $quantity, unitPrice: $unitPrice, discountPct: $discountPct, finalPrice: $finalPrice, addedAt: $addedAt, updatedAt: $updatedAt)';
  }
