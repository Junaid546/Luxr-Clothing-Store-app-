...
import 'package:stylecart/features/orders/domain/usecases/get_all_orders_usecase.dart';
import 'package:stylecart/features/orders/domain/usecases/get_user_orders_usecase.dart';
...
import 'package:stylecart/features/orders/domain/usecases/watch_user_orders_usecase.dart';
...
WatchUserOrdersUseCase watchUserOrdersUseCase(
  WatchUserOrdersUseCaseRef ref,
    ...
    WatchUserOrdersUseCase(ref.watch(orderRepositoryProvider));

@riverpod
GetUserOrdersUseCase getUserOrdersUseCase(
  GetUserOrdersUseCaseRef ref,
) =>
    GetUserOrdersUseCase(ref.watch(orderRepositoryProvider));
...
ConfirmReturnUseCase confirmReturnUseCase(
  ConfirmReturnUseCaseRef ref,
    ...
    ConfirmReturnUseCase(ref.watch(orderRepositoryProvider));

@riverpod
GetAllOrdersUseCase getAllOrdersUseCase(
  GetAllOrdersUseCaseRef ref,
) =>
    GetAllOrdersUseCase(ref.watch(orderRepositoryProvider));

@riverpod
SearchOrdersUseCase searchOrdersUseCase(
  SearchOrdersUseCaseRef ref,
) =>
    SearchOrdersUseCase(ref.watch(orderRepositoryProvider));
