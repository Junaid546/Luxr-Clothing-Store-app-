...
class OrderModel with _$OrderModel {
  ...
  factory OrderModel.fromFirestore(DocumentSnapshot doc) {
    ...
    final history = rawHistory
        .map((h) => StatusHistoryEntry.fromMap(h as Map<String, dynamic>))
        .toList();
    ...
    return OrderModel(
      ...
      shippingMethod: d['shippingMethod'] as String? ?? 'standard',
      shippingAddress: ShippingAddressModel.fromMap(
          d['shippingAddress'] as Map<String, dynamic>? ?? {}),
      estimatedDelivery: EstimatedDeliveryModel.fromMap(
          d['estimatedDelivery'] as Map<String, dynamic>? ?? {}),
      ...
      courier: d['courier'] != null
          ? CourierModel.fromMap(d['courier'] as Map<String, dynamic>)
          : null,
...
class ShippingAddressModel extends Equatable {
  ...
  factory ShippingAddressModel.fromMap(Map<String, dynamic> m) =>
...
class EstimatedDeliveryModel extends Equatable {
  ...
  factory EstimatedDeliveryModel.fromMap(Map<String, dynamic> m) =>
...
class CourierModel extends Equatable {
  ...
  const CourierModel({this.name, this.trackingNumber, this.estimatedTime});

  factory CourierModel.fromMap(Map<String, dynamic> m) => CourierModel(
