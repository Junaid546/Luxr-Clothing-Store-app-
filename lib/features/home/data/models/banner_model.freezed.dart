...
class _$BannerModelImpl extends _BannerModel {
  ...
  @override
  String toString() {
    return 'BannerModel(bannerId: $bannerId, title: $title, subtitle: $subtitle, imageUrl: $imageUrl, actionLabel: $actionLabel, actionRoute: $actionRoute, sortOrder: $sortOrder, isActive: $isActive, startDate: $startDate, endDate: $endDate, createdAt: $createdAt)';
  }
