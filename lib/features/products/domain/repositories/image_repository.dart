...
abstract interface class ImageRepository {
  // Upload a single image and return its remote URL.
  ...
  // Upload multiple images and return remote URLs in order.
  Future<Either<Failure, List<String>>> uploadProductImages({
    required List<String> localPaths,
    required String productId,
  });

  // Delete a single remote image if the backing service supports it.
  Future<Either<Failure, void>> deleteImage(String imageUrl);

  // Delete multiple remote images.
  Future<Either<Failure, void>> deleteImages(List<String> imageUrls);

  // Upload a profile photo and return its remote URL.
