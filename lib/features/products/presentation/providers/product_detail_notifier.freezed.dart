...
class _$ProductDetailStateImpl implements _ProductDetailState {
  ...
  @override
  String toString() {
    return 'ProductDetailState(product: $product, isLoading: $isLoading, hasError: $hasError, errorMessage: $errorMessage, selectedSize: $selectedSize, selectedColor: $selectedColor, quantity: $quantity, currentImageIndex: $currentImageIndex, isWishlisted: $isWishlisted)';
  }
