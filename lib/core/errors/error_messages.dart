...
class ErrorMessages {
  ...
  static String fromFirebaseAuthCode(String code) => switch (code) {
        ...
        'operation-not-allowed' => 'This login method is not enabled. Please contact support.',
        'account-exists-with-different-credential' =>
          'An account already exists with this email using a different sign-in method.',
        'requires-recent-login' => 'For security, please sign in again to complete this action.',
        'credential-already-in-use' => 'This credential is already linked to another account.',
        _ => kDebugMode ? 'Auth error: $code' : 'Authentication failed. Please try again.',
      };
  ...
  static String fromFirestoreCode(String? code) => switch (code) {
        ...
        'deadline-exceeded' => 'The operation timed out. Please check your connection.',
        'cancelled' => 'The operation was cancelled.',
        _ => kDebugMode ? 'Firestore error: $code' : 'A server error occurred. Please try again.',
      };

  // ── Generic user-safe messages ─────────────────────
  static const String networkError = 'Connection failed. Please check your internet connection.';

  static const String serverError = 'Something went wrong on our end. Please try again in a moment.';
  ...
  static const String outOfStock = 'Sorry, this item is no longer available in the selected size.';

  static const String cartFull = 'Your cart is full. Please remove an item before adding more.';

  static const String orderPlacementFailed = 'Unable to place your order. Please check your cart and try again.';

  static const String imageTooLarge = 'Image size must be under 5MB. Please choose a smaller image.';

  static const String invalidFileType = 'Only JPG, PNG and WEBP images are supported.';
}
