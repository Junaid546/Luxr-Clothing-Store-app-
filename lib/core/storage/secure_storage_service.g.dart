...
String _$secureStorageServiceHash() =>
    r'5d56e5305c94b8bdd0b534458b11175893c5ac45';

/// See also [secureStorageService].
@ProviderFor(secureStorageService)
final secureStorageServiceProvider =
    AutoDisposeFutureProvider<SecureStorageService>.internal(
...
typedef SecureStorageServiceRef =
    AutoDisposeFutureProviderRef<SecureStorageService>;
